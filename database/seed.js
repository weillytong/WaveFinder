...
Surf.insertMany([
  {
    ...
    beachImg: 'http://joeropersurfboardrepair.com/wp-content/uploads/2016/04/Screen-Shot-2016-04-12-at-7.24.45-PM.png',
    city: 'San Diego',
    surf: '1-2',
    ...
    suit: [
      {
        img: 'https://images.boardriders.com/global/billabong-products/all/default/hi-res/mwfu3bf4_billabong,v_blk_sd1.jpg',
        suitName: '4/3 Furnace Carbon Chest Zip',
        website: 'https://www.billabong.com/4/3-furnace-carbon-chest-zip-MWFUQBF4.html'
      }
    ],
  ...
  },
  {
    id: 2,
    beach: 'Pacific Beach',
    beachImg: 'https://upload.wikimedia.org/wikipedia/commons/7/70/Pacific_Beach_Skyline.jpg',
    city: 'San Diego',
    surf: '2-3',
    report: 'Still on the smaller side this afternoon as primary SSW swell rolls in over smaller NW swell mix, good for mostly knee-waist high surf. Some texture from light+ to locally moderate westerly onshore wind but overall it\'s pretty manageable with soft, cruisy corners to work with. Tide is still on the full side, dropping down to a 4:20pm low of -0.1.',
    tide: '1.8',
  ...
  },
  {
    ...
    beachImg: 'https://www.californiabeaches.com/wp-content/uploads/2014/09/Tourmaline-Surf-Park-Beach-Bryce-Apr2016-4-1000x532.jpg',
    city: 'San Diego',
    surf: '1-2',
    report: 'Still on the smaller side this afternoon as primary SSW swell rolls in over smaller NW swell mix, good for mostly knee-waist high surf. Some texture from light+ to locally moderate westerly onshore wind but overall it\'s pretty manageable with soft, cruisy corners to work with. Tide is still on the full side, dropping down to a 4:20pm low of -0.1.',
    tide: '1.8',
  ...
  },
  {
    id: 4,
    beach: 'Black\'s Beach',
    beachImg: 'https://d14fqx6aetz9ka.cloudfront.net/wp-content/uploads/2018/05/03094559/05-1560x866.jpg',
    city: 'San Diego',
    surf: '2-3',
    report: 'Still on the smaller side this afternoon as primary SSW swell rolls in over smaller NW swell mix, good for mostly knee-waist high surf. Some texture from light+ to locally moderate westerly onshore wind but overall it\'s pretty manageable with soft, cruisy corners to work with. Tide is still on the full side, dropping down to a 4:20pm low of -0.1.',
    tide: '1.8',
  ...
  },
  {
    ...
    beachImg: 'https://www.californiabeaches.com/wp-content/uploads/2014/09/bigs-Venice-Beach-Aerial-view-of-the-shoreline-in-Venice-CA-at-dusk-Large-1000x667.jpg',
    city: 'Los Angeles',
    surf: '2-3',
  ...
  },
  {
    ...
    beachImg: 'https://d1y7kerpdff7pl.cloudfront.net/El%20Porto%20Beach%20Santa%20Monica.jpg',
    city: 'Los Angeles',
    surf: '3-4',
